...
imsg.lineTop = imsg:CreateTexture(nil, 'OVERLAY')
imsg.lineTop:SetDrawLayer('OVERLAY', 2)
imsg.lineTop:SetTexture([[Interface\Scenarios\ScenariosParts]])
imsg.lineTop:SetPoint("TOP")
imsg.lineTop:SetSize(61, 19)
imsg.lineTop:SetTexCoord(0.08007813, 0.19921875, 0.05859375, 0.02148438)
