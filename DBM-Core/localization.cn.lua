...
DBM_CORE_BOSS_DOWN_L				= "%s被击杀！本次用时%s，上次用时%s，最快击杀用时%s。总击杀%d次。"
DBM_CORE_BOSS_DOWN_NR				= "%s被击杀！用时%s，新的击杀纪录诞生了！（原纪录为%s）总击杀%d次。"
DBM_CORE_COMBAT_ENDED_AT			= "%s(%s)作战结束，用时%s。"
DBM_CORE_COMBAT_ENDED_AT_LONG		= "%s（%s）作战结束，用时%s。你在这个难度总共灭团%d次。"
...
DBM_CORE_WHISPER_COMBAT_END_KILL_STATS		= "%s已经击败%s! 他们总共击杀%d次。"
DBM_CORE_WHISPER_COMBAT_END_WIPE_AT	= "%s在%s(%s)的战斗中灭团了。"
DBM_CORE_WHISPER_COMBAT_END_WIPE_STATS_AT	= "%s在%s(%s)的战斗中灭团了。他们在这个难度总共灭团%d次。"
...
DBM_CORE_AUTO_TIMER_OPTIONS = {
	...
	cdsource	= "显示$spell:%s及其施放者冷却计时",
	next					= "显示下一次$spell:%s计时",
	nextcount					= "显示下一次$spell:%s计数计时",
	nextsource	= "显示下一次$spell:%s及其施放者计时",
