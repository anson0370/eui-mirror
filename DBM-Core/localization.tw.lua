...
DBM_CORE_COMBAT_ENDED_AT_LONG		= "%s(%s)的戰鬥經過%s結束。你在這個難度總共滅團%d次。"
...
DBM_CORE_WHISPER_COMBAT_END_KILL_STATS		= "%s已經擊敗%s! 他們總共擊殺了%d次。"
DBM_CORE_WHISPER_COMBAT_END_WIPE_AT	= "%s在%s(%s)的戰鬥中滅團了。"
DBM_CORE_WHISPER_COMBAT_END_WIPE_STATS_AT	= "%s在%s(%s)的戰鬥中滅團了。他們在這個難度總共滅團%d次。"
...
DBM_CORE_AUTO_TIMER_OPTIONS = {
	...
	cdsource	= "為$spell:%s及其施放者顯示冷卻計時器",
	next					= "為下一次$spell:%s顯示計時器",
	nextcount					= "為下一次$spell:%s顯示計數計時器",
	nextsource	= "為下一次$spell:%s及其施放者顯示計時器",
