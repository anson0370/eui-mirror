...
L.DisableCinematics			= "在副本中禁止播放游戏过场电影"
L.DisableCinematicsOutside	= "在副本外禁止播放游戏过场电影"
...
-- Tab: Generalwarnings
L.Tab_GeneralMessages 		= "常规信息"
L.CoreMessages				= "核心信息选项"
L.ShowLoadMessage 			= "在聊天窗口显示模块加载信息"
L.ShowPizzaMessage 			= "在聊天窗口显示计时广播信息"
L.CombatMessages			= "战斗信息选项"
L.ShowEngageMessage 		= "在聊天窗口显示开战信息"
L.ShowKillMessage 			= "在聊天窗口显示击杀信息"
L.ShowWipeMessage 			= "在聊天窗口显示灭团信息"
L.ShowRecoveryMessage 		= "在聊天窗口显示计时条恢复信息"
L.WhisperMessages			= "密语信息选项"
L.AutoRespond 		= "开启战斗中自动密语回复"
L.EnableStatus 		= "回复“status”密语"
L.WhisperStats 				= "在密语回复中加入击杀/灭团状态"
