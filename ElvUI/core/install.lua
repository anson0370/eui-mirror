...
function E:SetupTheme(theme, noDisplayMsg)
	...
	if GetLocale()=="zhCN" then
		E.db.general.font = "Ä¬ÈÏ"
		E.db.unitframe.font = "Ä¬ÈÏ"
		E.private.general.dmgfont = "ÉËº¦Êý×Ö"
		E.db.chat.font = "Ä¬ÈÏ"
		E.db.unitframe.fontoutline = "OUTLINE"
	elseif GetLocale() == "zhTW" then
		E.db.general.font = "îAÔO"
		E.db.unitframe.font = "îAÔO"
		E.private.general.dmgfont = "‚ûº¦”µ×Ö"
		E.db.chat.font = "îAÔO"
		E.db.unitframe.fontoutline = "OUTLINE"
	end
	
	--Set colors
	if theme == "classic" or theme == "transparent" then
...
function E:SetupUFStyle(value)
	...
	if value == 1 then
		...
		E.db.unitframe.units.raid25.power.width = 'fill'
	...
	elseif value == 4 then
		...
		E.db.unitframe.units.raid25.power.width = 'fill'
		E.db.unitframe.units.raid25.power.offset = 6
		E.db.unitframe.units.boss.power.width = 'fill'
