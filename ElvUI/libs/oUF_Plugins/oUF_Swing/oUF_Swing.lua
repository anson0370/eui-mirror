...
function oUF_Swing_Melee(...)
	local event, _, subevent, _, GUID = ...
	if not _G["ElvUF_Player"] then return end
	local self = _G["ElvUF_Player"]
...
local Enable = function(self, unit)
	...
	if bar and unit == "player" then
		...
		--	self:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED", oUF_Swing_Melee)
		--	self:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED", oUF_Swing_ParryHaste)
...
local Disable = function(self)
	...
	if bar then
		...
		if not bar.disableMelee then
		--	self:UnregisterEvent("COMBAT_LOG_EVENT_UNFILTERED", oUF_Swing_Melee)
		--	self:UnregisterEvent("COMBAT_LOG_EVENT_UNFILTERED", oUF_Swing_ParryHaste)
