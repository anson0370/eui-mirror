...
local function BuildBAR(BarWidth, IconSize, i)
	...
	Frame.Statusbar = E.db.general.transparent and E:TranseBar(Frame) or CreateFrame("StatusBar", nil, Frame)
	...
	Frame.Spellname:FontTemplate(LSM:Fetch("font", Module.db.font), Module.db.fontSize, Module.db.fontOutline)
