...
function B:Layout(isBank)
	...
	if not isBank then
		...
		if E.db.bags.bagCols == 0 then
			cols = floor((E.db.chat.rightpanelWidth - 10)/370 * 10)
			bagWidth = E.db.chat.rightpanelWidth - 10
		else
		...
		if E.db.bags.bankCols == 0 then
			cols = floor((E.db.chat.leftpanelWidth - 10)/370 * 10)
			bagWidth = E.db.chat.leftpanelWidth - 10
		else
...
function B:Initialize()
	self:LoadBagBar()
	for _, v in pairs(OtherBagAddon) do
