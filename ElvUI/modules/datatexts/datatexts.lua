...
function DT:LoadDataTexts()
	...
	if self.db.panels.ABLeftInfobar == '' then ABLeftInfobar:Hide() else ABLeftInfobar:Show() end
	if self.db.panels.ABRightInfobar == '' then ABRightInfobar:Hide() else ABRightInfobar:Show() end
