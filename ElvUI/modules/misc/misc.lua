...
function M:COMBAT_LOG_EVENT_UNFILTERED(_, _, event, _, sourceGUID, sourceName, _, _, _, destName, _, _, _, _, _, spellID, spellName)
	...
	if E.db.general.interruptAnnounce == "PARTY" and inGroup then
		SendChatMessage(sourceName.. " ".. INTERRUPT.." "..destName.."'s \124cff71d5ff\124Hspell:"..spellID.."\124h["..spellName.."]\124h\124r!", IsPartyLFG() and "INSTANCE_CHAT" or "PARTY")
	elseif E.db.general.interruptAnnounce == "RAID" and inGroup then
		if inRaid then
			SendChatMessage(sourceName.. " ".. INTERRUPT.." "..destName.."'s \124cff71d5ff\124Hspell:"..spellID.."\124h["..spellName.."]\124h\124r!", IsPartyLFG() and "INSTANCE_CHAT" or "RAID")
		else
			SendChatMessage(sourceName.. " ".. INTERRUPT.." "..destName.."'s \124cff71d5ff\124Hspell:"..spellID.."\124h["..spellName.."]\124h\124r!", IsPartyLFG() and "INSTANCE_CHAT" or "PARTY")
		end	
	elseif E.db.general.interruptAnnounce == "SAY" and inGroup then
		SendChatMessage(sourceName.. " ".. INTERRUPT.." "..destName.."'s \124cff71d5ff\124Hspell:"..spellID.."\124h["..spellName.."]\124h\124r!", "SAY")	
	end
end
