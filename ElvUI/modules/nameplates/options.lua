				...
				auras = {
					...
					args = {
						...
						iconsize = {
							...
							name = L["Icon Size"],
							min = 5, max = 50, step = 1,
							get = function(info) return E.db.nameplate.iconsize end,
							set = function(info, value) E.db.nameplate.iconsize = value end,
						},
						fontsize = {
							type = "range",
							order = 4,
							name = L["Font Size"],
							min = 5, max = 50, step = 1,
							get = function(info) return E.db.nameplate.fontsize end,
							set = function(info, value) E.db.nameplate.fontsize = value end,							
						},						
					},
				},
				reactions = {
