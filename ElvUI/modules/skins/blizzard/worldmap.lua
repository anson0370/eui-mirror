...
local function LoadSkin()
	...
	if MapsterOptionsButton then S:HandleButton(MapsterOptionsButton) end
	if MapsterQuestObjectivesDropDown then S:HandleDropDownBox(MapsterQuestObjectivesDropDown) end
end
