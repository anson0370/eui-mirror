...
local BossData = {
	...
	["魔古山宫殿"] = {
		{name = "君王试炼", raiders = "注意 坦克拉开 怪物其实位置，不然捅菊花的近战会被强制瞬移到场地中央。"},
		{name = "杰翰", raiders = "注意 千万不要带入内测服的打法AAA，正常控制打吧(装备好了再AAA)"},
		{name = "武器大师席恩", raiders = "注意躲好各种技能，坦克注意震荡波。(PS，推荐击杀位置为进门右手边 石狮子附近。坦克背对墙壁/柱子，DPS 背后爆菊)"},
	},
	["围攻砮皂寺"] = {
		{name = "宰相金巴卡", raiders = "是盘菜,直接上吧"},
		{name = "指挥官沃加克", raiders = "扔好 基友 焦油，玩过兽人必须死吧？丢一路连起来，怪物DEBUFF会很快到20层。(PS：焦油就在台子边上，右键之后，会减缓移动速度)"},
		{name = "将军帕瓦拉克", raiders = "坑爹的BOSS，注意用好炸弹(炸弹到底是用来处理小怪、BOSS盾。还是手动处理小怪，破盾之后丢BOSS 要商量好)，炸弹要节省啊！"},
		{name = "翼虫首领尼诺洛克", raiders = "T拉好,奶住,轰吧!" },
	},
	["残阳关"] = {
		{name = "破坏者吉普提拉克", raiders = "出啥躲啥..."},
		{name = "突袭者加杜卡", raiders = "出啥躲啥，出啥打啥。治疗注意看好点名，坦克看血线看技能。"},
		{name = "指挥官瑞魔克", raiders = "出啥躲啥，出啥打啥"},
		{name = "莱公", raiders = "P1,DPS 记得用火炮把自己弄到BOSS身上，开技能打弱点(两个就可以了) P2，点名风筝，RUSH BOSS。"},
	},
	["血色大厅"] = {
		{name = "驯犬者布兰恩", raiders = "分散站开，控制够，就控狗。不够就先杀狗吧。"},
		{name = "武器大师哈兰", raiders = "注意顺劈，躲好大招。"},
		{name = "织焰者孔格勒", raiders = "打断技能，驱散DOT，躲喷射。"},
	},
	["血色修道院"] = {
		{name = "裂魂者萨尔诺斯", raiders = "打断技能，BOSS拉离小怪尸体" },
		{name = "科洛夫修士", raiders = "出啥躲啥，坦克拉好，DPS猛抽，治疗压力大。"},
		{name = "指挥官杜兰德", raiders = "打断技能，先杀奶妈"},
		{name = "大检察官怀特迈恩", raiders = "打断技能，先杀奶妈"},
	},
	["通灵学院"] = {
		{name = "指导者寒心", raiders = "P1，猛抽，大奶 P2，猛抽，躲技能"},
		{name = "詹迪斯•巴罗夫", raiders = "猛抽，躲地上的黑水，猜谜阶段，看RP吧。"},
		{name = "血骨傀儡", raiders = "所有人保持骨盾的BUFF(就在骨头推，自己点)。坦克，拉近骨头堆，BUFF没了立即点骨头(骨头堆起火，身上没骨盾，开技能跑向下个骨头堆)"},
		{name = "莉莉安•沃斯", raiders = "P1 中火放外圈 P2 点名风筝 P3=P1+P2." },
		{name = "黑暗院长加丁", raiders = "A小怪，传送打怪出来继续抽BOSS。"},
	}
}
